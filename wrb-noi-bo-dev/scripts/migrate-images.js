...
const IMAGE_MAP = [
    ...
    { url: "https://i.postimg.cc/4xDZ4cxg/only-logo-500x500px-(maltic-gold)-1.png", dest: "assets/logos/logo-only-gold.webp" },
...
async function migrate() {
    console.log('🚀 Starting Image Migration to WebP (CommonJS)...');
